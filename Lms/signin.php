...
include_once'Header.php';
	...
	<div class="row">
		<div class="col-md-12">
<form class="form-group col-md-6" method="POST" action="loginaction.php">
	<header>
		<h4 style="color: white"><img src="Images/2.JFIF" style="width:100%; height: auto;"></h4><br>
		<h3 style="color: purple;"><u>Learning Management System</u></h3>
	</header>
	
	<p style="color: blue; margin-top:5px">Please sign in with your UET Mardan acount</p><br>
	<?php  
if (@$_GET['Empty']==true) {
	?>
...
function myFunction(){
	...
	<a href="signup.php" style="float: right;">Not Registered? Sign Up</a>
</form>
</div>
</div>
</div>
